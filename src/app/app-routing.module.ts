...
const routes: Routes = [
  { path: '', redirectTo: 'senarai-kehadiran', pathMatch: 'full' },
  ...
  { path: 'senarai-kehadiran', loadChildren: './senarai-kehadiran/senarai-kehadiran.module#SenaraiKehadiranPageModule' },
];
